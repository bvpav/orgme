  ...
  "inline-flex items-center justify-center rounded-md text-sm font-semibold ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-800",
  {
    variants: {
      variant: {
        ...
        outline: "border border-gray-200 hover:bg-gray-100 hover:text-white",
        secondary: "bg-gray-100/10 text-white hover:bg-gray-100/20",
        ghost: "hover:bg-gray-100/10 text-white",
